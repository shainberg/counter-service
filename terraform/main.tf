...
resource "aws_iam_role_policy_attachment" "eks_role_policy" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"  # Grants EKS permissions
}
...
resource "aws_iam_role_policy_attachment" "attach_eks_node_policy" {
  role       = "node-group-1-eks-node-group-<unique-id>" # Replace with your actual role name
